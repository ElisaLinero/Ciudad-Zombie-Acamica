...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo("imagenes/valla_vertical.png", 120, 470, 30, 30, 1),
    new Obstaculo("imagenes/valla_horizontal.png", 70, 430, 30, 30, 1),
    new Obstaculo("imagenes/bache.png", 300, 470, 30, 30, 1),
    new Obstaculo("imagenes/auto_verde_abajo.png", 550, 250, 15, 30, 1),
    new Obstaculo("imagenes/auto_verde_derecha.png", 420, 400, 30, 15, 1),
    new Obstaculo("imagenes/bache.png", 550, 75, 30, 30, 1),
    new Obstaculo("imagenes/valla_vertical.png", 500, 470, 30, 30, 1),
    new Obstaculo("imagenes/valla_horizontal.png", 550, 430, 30, 30, 1),
    new Obstaculo("imagenes/bache.png", 760, 200, 30, 30, 1),
  ...
  enemigos: [
    new ZombieCaminante("imagenes/zombie1.png", 350, 135, 10, 10, 1, {
      desdeX: 0,
      hastaX: 577,
      desdeY: 0,
      hastaY: 961
    }),
    new ZombieCaminante("imagenes/zombie2.png", 290, 310, 10, 10, 1, {
      desdeX: 0,
      hastaX: 870,
      desdeY: 0,
      hastaY: 961
    }),
    new ZombieCaminante("imagenes/zombie3.png", 310, 200, 10, 10, 1, {
      desdeX: 0,
      hastaX: 870,
      desdeY: 0,
      hastaY: 961
    }),
    new ZombieCaminante("imagenes/zombie4.png", 250, 620, 10, 10, 1, {
      desdeX: 0,
      hastaX: 870,
      desdeY: 0,
      hastaY: 961
    }),
    new ZombieCaminante("imagenes/zombie1.png", 820, 330, 10, 10, 1, {
      desdeX: 0,
      hastaX: 870,
      desdeY: 0,
      hastaY: 961
...
Juego.capturarMovimiento = function(tecla) {
  ...
  if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
    ...
    de sus metodos  */
    /* COMPLETAR */
    this.jugador.morvese(movX, movY);
  }
};
